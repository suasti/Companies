...
Companies is a base Extra template that is useful when wanting to add a new
Company for MODx Revolution. One can git archive from this repository to start
...
`git clone http://github.com/suasti/Companies.git ./`

Then, create the target directory where you want to create the file.

Then, navigate to the directory Companies is now in, and do this:
...
Now, you'll want to change references to Companies in the files in your
new copied-from-Companies repo to whatever name of your new Extra will be. Once
...
Also, you'll want to change all the references of 'Companies' to whatever the
name of your component is.

## Copyright Information

Companies is distributed as GPL (as MODx Revolution is), but the copyright owner
(Aleksandr Fesenko) grants all users of Companies the ability to modify, distribute
and use Companies in MODx development as they see fit, as long as attribution
