...
$_lang['companies_menu_desc'] = 'Пример расширения для разработки.';
$_lang['companies_intro_msg'] = 'Вы можете выделять сразу несколько строк при помощи Shift или Ctrl.';

$_lang['company_settings'] = 'Настройки';
$_lang['company_settings_desc'] = 'Настройки компонента.';

$_lang['company_id'] = 'Id';
$_lang['company_name'] = 'Название';
$_lang['company_description'] = 'Описание';
$_lang['company_requisites'] = 'Реквизиты';
$_lang['company_status'] = 'Активно';
$_lang['company_admin'] = 'Админ';
$_lang['company_memberss'] = 'Представители';


$_lang['company_user_positions'] = 'Должности';
$_lang['company_user_intro'] = 'Должности intro';


$_lang['company_create'] = 'Создать компанию';
$_lang['company_update'] = 'Изменить компанию';
$_lang['company_enable'] = 'Включить компанию';
$_lang['companies_enable'] = 'Включить компании';
$_lang['company_disable'] = 'Отключить компанию';
$_lang['companies_disable'] = 'Отключить компании';
$_lang['company_remove'] = 'Удалить компанию';
$_lang['companies_remove'] = 'Удалить компании';
$_lang['company_remove_confirm'] = 'Вы уверены, что хотите удалить эту компанию?';
$_lang['companies_remove_confirm'] = 'Вы уверены, что хотите удалить эти компании?';
$_lang['company_status'] = 'Включено';

$_lang['company_err_name'] = 'Вы должны указать название компании.';
$_lang['company_err_ae'] = 'Компания с таким названием уже существует.';
$_lang['company_err_nf'] = 'Компания не найдена.';
$_lang['company_err_ns'] = 'Компания не указана.';
$_lang['company_err_remove'] = 'Ошибка при удалении компании.';
$_lang['company_err_save'] = 'Ошибка при сохранении компании.';

$_lang['companies_grid_search'] = 'Поиск';
$_lang['companies_grid_actions'] = 'Действия';
